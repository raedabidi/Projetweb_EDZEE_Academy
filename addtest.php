...
<head>
    ...
    <link rel="stylesheet" href="css/bootstrap-id_formpicker.css">
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="TEST.html" class="nav-link">Quiz</a></li>
              </ul>
            </nav>
          </div>
    ...
    <form action="" method="POST">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="id_form" id="id_form" name="id_form" />
...
<footer class="footer-section bg-white">
      <div class="container">
        ...
        Copyright &copy;<script>document.write(new id_form().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      </p>
            </div>
          </div>
  ...
  <script src="js/bootstrap-id_formpicker.min.js"></script>
