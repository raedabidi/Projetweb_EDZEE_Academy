...
!empty($_POST["nbrrep"]) &&
 !empty($_POST["datecre"])&&
 !empty($_POST["id_test"]))  {
 // Contrôle de saisie pour prof 
if (strlen($_POST['nbrrep']) > 8 ) 
{ $error = "Le nombre de question doit etre superieur a 8"; }
 else { $question = new question( null, $_POST['ques'], $_POST['prof'], $_POST['nbrrep'], $_POST['datecre'], $_POST['prix'] ); 
$questionC->addquestion($question); 
header('Location:listquestion.php');
 } }
 else $error = "Inquestions manquantes."; }?>
 <html lang="en">
...
<head>
    ...
    <link rel="stylesheet" href="css/bootstrap-nbrreppicker.css">
    ...
    <form action="" method="POST">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="prof" name="prof" placeholder="prof" />
            ...
            <tr>
                ...
                <td>
                    <input type="nbrrep" id="nbrrep" name="nbrrep" />
            ...
            <tr>
                ...
                <td>
                    <input type="date" id="datecre" name="datecre" placeholder="datecre" />
                    <span id="erreurdatecre" style="color: red"></span>
                </td>
            </tr>
            <tr>
                <td><label for="id_test">id_test :</label></td>
                <td>
                    <input type="text" id="id_test" name="id_test" placeholder="id_test" />
                    <span id="erreurdid_test" style="color: red"></span>
                </td>
            </tr>
...
<footer class="footer-section bg-white">
      <div class="container">
        ...
        Copyright &copy;<script>document.write(new nbrrep().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >Colorlib</a>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      </p>
            </div>
          </div>
  ...
  <script src="js/bootstrap-nbrreppicker.min.js"></script>
