<?php include '../Controller/testC.php';
 $error = "";
 // create client 
$test = null;
 // create an instance of the controller
 $testC = new testC();
 if ( isset($_POST["score_min"]) && 
isset($_POST["score_max"]) &&
 isset($_POST["date"]) &&
 isset($_POST["duree"]) ) 
{ if ( !empty($_POST['score_min']) &&
 !empty($_POST["score_max"]) && 
!empty($_POST["date"]) &&
 !empty($_POST["duree"]) ) {
 // Contrôle de saisie pour score_max 
if (strlen($_POST['score_max']) > 3 ) 
{ $error = "Le score_max doit etre superieur au score min."; }
 elseif ($_POST['score_min'] >= $_POST['score_max']) 
{ $error = "Le score_min doit être inférieur au score_max."; }
 else { $test = new test( null, $_POST['score_min'], $_POST['score_max'], $_POST['date'], $_POST['duree'] ); 
$testC->addtest($test); 
...
<header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="#programs-section" class="nav-link">test</a></li>
    ...
    <div class="site-section" id="programs-section">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">Our test</h2>

    <a href="listtest.php">Back to list </a>
    <hr>
    ...
    <form action="" method="POST">
        <table>
            <tr>
                <td><label for="score_min">score_min :</label></td>
                <td>
                    <input type="text" id="score_min" name="score_min" placeholder="score_min" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="score_max" name="score_max" placeholder="score_max" />
